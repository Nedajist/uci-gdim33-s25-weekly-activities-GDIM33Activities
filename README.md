...
1. The main pattern emerging from my inspiration sources is time/causality interference abilities from various video games and stories. I'm interested in creating a puzzle/tactical game where the user is capable of manipulating cause and effect (and, potentially as a consequence, memory). The images also show my interest in either a top-down 2D pixel-art style or a 2D sidescoller game.
